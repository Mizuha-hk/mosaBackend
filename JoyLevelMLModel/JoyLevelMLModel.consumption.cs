...
{
    public partial class JoyLevelMLModel
    {
        /// <summary>
        /// model input class for JoyLevelMLModel.
        /// </summary>
        ...
        public class ModelInput
        {
            ...
            public float Avg__Readers_Joy { get; set; }
        ...
        /// <summary>
        /// model output class for JoyLevelMLModel.
        /// </summary>
        ...
        public class ModelOutput
        {
            ...
            [ColumnName(@"Avg. Readers_Joy")]
            public uint Avg__Readers_Joy { get; set; }
        ...
        private static string MLNetModelPath = Path.GetFullPath("JoyLevelMLModel.mlnet");
        ...
        private static IEnumerable<string> GetLabels(ModelOutput result)
        {
            ...
            var labelColumn = schema.GetColumnOrNull("Avg. Readers_Joy");
            if (labelColumn == null)
            {
                throw new Exception("Avg. Readers_Joy column not found. Make sure the name searched for matches the name in the schema.");
            }
